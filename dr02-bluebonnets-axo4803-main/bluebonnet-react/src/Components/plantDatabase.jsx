const plantDatabase = [
	{
		...
		name: "Succulent",
		Sunlight: "6 hrs of direct sunlight",
    ...
    {
        image:"https://herbgardening.com/HerbGardeningImages/ParsleyPotted500.jpg",
        name: "Cilantro",
        Sunlight: "6-8 hrs of direct sunlight",
        Water: "Water once a week",
        Warnings: "wind",
        Description: "Cilantro is a strong, distinctive-smelling herb that's often used in Mexican and Indian cooking. While cilantro looks very similar to parsley, its flavor is much stronger."
    },
    {
        image:"https://cdn.mos.cms.futurecdn.net/RMt9NRPQGLE9ftU3KYbJya.jpg",
        name: "Parsley",
        Sunlight: "6-8 hrs of direct sunlight",
        Water: "Water once a week",
        Warnings: "heat",
        Description: "An aromatic herb with flat or crinkly leaves that are cut finely and used to garnish food"
    }
